class Horoscope {
  ...
  String title;
  String subtitle;
  double indicatorValueMoney;
  double indicatorValueLove;
  double indicatorValueHealth;
  ...
  Horoscope({
    ...
    this.title,
    this.subtitle,
    this.indicatorValueMoney,
    this.indicatorValueLove,
    this.indicatorValueHealth,
    this.content,
  });
}
...
List getHoroscopes() {
  return [
    Horoscope(
        image: "assets/011-aquarius.png",
        title: "AQUARIUS",
        subtitle: "January 20 - February 18",
        indicatorValueMoney: 0.11,
        indicatorValueLove: 0.55,
        indicatorValueHealth: 0.33,
        content:
    ...
    Horoscope(
        image: "assets/009-pisces.png",
        title: "PISCES",
        subtitle: "February 19 - March 20",
        indicatorValueMoney: 0.88,
        indicatorValueLove: 0.55,
        indicatorValueHealth: 0.33,
        content:
    ...
    Horoscope(
        image: "assets/008-sagittarius.png",
        title: "SAGITTARIUS",
    ...
    Horoscope(
        image: "assets/003-capricorn.png",
        title: "CAPRICORN",
